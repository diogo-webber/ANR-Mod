...
function GetFiveRadius(x, z, prefab)
    ...
    if
        ...
        or GetWorld().generated == nil
        -- Probably some kind of special node like a blocker, doesn't have generated contents anyways.
        or GetWorld().topology.ids[area] == nil or GetWorld().generated.densities[GetWorld().topology.ids[area]] == nil
        then

        return
    end

    local density = GetWorld().generated.densities[GetWorld().topology.ids[area]][prefab]
    if density == nil then

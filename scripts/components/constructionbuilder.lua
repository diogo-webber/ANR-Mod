...
function ConstructionBuilder:SetContainer(constructioninst)
    self.constructioninst = constructioninst
end

function ConstructionBuilder:SetTarget(constructionsite)

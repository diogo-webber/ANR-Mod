...
local function OnKilled(inst)
    inst.components.timer:StartTimer(DRAGONFLY_SPAWNTIMER, TUNING.DRAGONFLY_RESPAWN_TIME)
end
...
local function fn()
    ...
    inst.components.timer:StartTimer(DRAGONFLY_SPAWNTIMER, TUNING.DRAGONFLY_RESPAWN_TIME, not TUNING.SPAWN_DRAGONFLY)
